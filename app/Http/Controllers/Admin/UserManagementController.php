...
class UserManagementController extends Controller
{
    ...
    /**
     * Handle import user dari file Excel.
     */
    public function import(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.usermanagement')->with('success', 'Import user berhasil!');
        } catch (\Maatwebsite\Excel\Validators\ValidationException $e) {
            $failures = $e->failures();

            // Bisa kirim errors ke view atau handle sesuai kebutuhan
            return redirect()->route('admin.usermanagement')->withErrors($failures);
        }
    }
