    ...
    <main class="px-4 sm:px-6 pt-4 md:pt-6 max-w-full">
        ...
        <div id="uploadFileModal"
            ...
            <div
                ...
                <!-- Form Upload -->
                <form id="importForm" action="{{ route('admin.usermanagement.import') }}" method="POST" enctype="multipart/form-data" class="mb-2">
                    @csrf
                        ...
                        <label for="dropzone-file"
                            ...
                            <div class="p-2 flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p id="fileUploadText"
                                    ...
                                    <span class="font-semibold" id="fileNameText">Click to upload</span> or drag and
                                    drop
                                </p>
                                <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 text-center">
                                    Only Excel files are allowed (xlsx, xls, csv)
                                </p>
                            </div>
                            <input id="dropzone-file" name="file" type="file" accept=".xlsx,.xls,.csv" class="hidden" required />
                        </label>
                    </div>
